...
# Fraction of minibatch that is labeled foreground (i.e. class > 0)F
...
__C.TRAIN.SNAPSHOT_ITERS = 2500  # 5000
...
__C.TRAIN.RPN_BATCHSIZE = 256  # 256

# NMS threshold used on RPN proposals
__C.TRAIN.RPN_NMS_THRESH = 0.7

# Number of top scoring boxes to keep before apply NMS to RPN proposals C.TRAIN.RPN_PRE_NMS_TOP_N = 12000
__C.TRAIN.RPN_PRE_NMS_TOP_N = 10000

# Number of top scoring boxes to keep after applying NMS to RPN proposals C.TRAIN.RPN_POST_NMS_TOP_N = 2000
